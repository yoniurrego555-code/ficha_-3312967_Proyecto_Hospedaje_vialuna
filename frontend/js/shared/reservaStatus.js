...
export function getStatusClass(estado) {
  const statusMap = {
    ...
    '5': 'px-2.5 py-1 rounded-lg text-xs font-bold bg-indigo-100 text-indigo-800 border border-indigo-200', // Finalizada
    ...
    'finalizada': 'px-2.5 py-1 rounded-lg text-xs font-bold bg-indigo-100 text-indigo-800 border border-indigo-200',
